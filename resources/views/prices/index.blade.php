...
<section id="overview">
    ...
    <div class="row form-group product-chooser">
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <div class="product-chooser-item">
          <img src="{{asset('images/websolutions/wordpress_priser.png')}}" class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="Wordpress Priser">
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <div class="product-chooser-item">
          <img src="{{asset('images/websolutions/bootstrap.png')}}" class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="Bootstrap Priser">
          <div class="col-xs-8 col-sm-8 col-md-12 col-lg-12">
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <div class="product-chooser-item">
          <img src="{{asset('images/websolutions/customkode.png')}}" class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="Custom kode priser">
          <div class="col-xs-8 col-sm-8 col-md-12 col-lg-12">
  ...
  <div class="row form-group product-chooser">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
      <div class="product-chooser-item">
        <img src="{{asset('images/webshop/magento_priser1.png')}}"
             class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="Magento priser">
        <div class="col-xs-8 col-sm-8 col-md-12 col-lg-12">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
      <div class="product-chooser-item">
        <img src="{{asset('images/webshop/shopify_priser.png')}}" class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="shopify priser">
        <div class="col-xs-8 col-sm-8 col-md-12 col-lg-12">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
      <div class="product-chooser-item">
        <img src="{{asset('images/webshop/woocommerce_priser.png')}}" class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="woocommerce priser">
        <div class="col-xs-8 col-sm-8 col-md-12 col-lg-12">
