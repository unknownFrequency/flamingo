...
<div class="k ae ajs">
  <div class="f baa">
    <a href="/webshops#magento-link"><img class="programs" src="{{asset('images/magentologo.png')}}"></a>
    <a href="/webshops#wordpress-link"><img class="programs" src="{{asset('images/wordpresslogo.png')}}"></a>
