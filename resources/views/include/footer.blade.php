<footer id="myFooter">
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                <h2 class="logo"><a href="#"><span class="header-highlight">Flamingo</span> #Media</a></h2>
                <h4 class="widget-title">Følg os på de sociale medier</h4>
                 <ul class="social-nav">
